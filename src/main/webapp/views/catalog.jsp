                            ...
                            <div id="catalog--container">
                                <form:form method="POST" action="/catalog" class="catalog--filter-side-bar"
                                        ...
                                        <div class="checkbox-list">
                                            <c:forEach var="category" items="${categories}">
                                                <div>
                                                    ...
                                                    <form:label for="${category.getId()}" path="categoryID">
                                                        ${category.getName()}</form:label>
                                                </div>
                                            </c:forEach>
                                        </div>
                                    </div>
                                    ...
                                    <div class="catalog--filter-side-bar-item catalog--filter-side-bar-price">
                                        ...
                                        <div>
                                            <form:input type="number" placeholder="Từ" name="priceFrom" min="0"
                                                path="minPrice" value="${criteria.getMinPrice()}" />
                                            <div class="separating-line"></div>
                                            <form:input type="number" placeholder="Đến" name="priceTo" min="0"
                                    ...
                                    <div class="catalog--filter-side-bar-item catalog--filter-side-bar-color">
                                        ...
                                        <c:forEach var="color" items="${colors}">
                                            <div>
                                                <form:checkbox id="${color}" name="colors" value="${color}"
                                                    path="colors" />
                                    ...
                                    <button type="submit" name="btnSubmit" value="submit"
                                        class="catalog--filter-side-bar-search-btn">Tìm kiếm</button>
                                    <button type="submit" name="btnSubmit" value="cancel"
                                        class="catalog--filter-side-bar-cancel-btn">Xóa tất cả</button>
                                </form:form>
                                    ...
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            ...
                                            <p class="catalog--product-notfound">
                                                <i class='bx bx-sad' style="font-size: 8rem"></i> Không tìm thấy sản
                                                phẩm phù hợp.
                                            </p>
                                        </c:otherwise>
                                    </c:choose>
